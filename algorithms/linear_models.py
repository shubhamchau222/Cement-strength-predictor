...
class LinearRegressionWithFeatureSelection:
    ...
    def backward_elimination_approach(self):
        ...
        """
        # Logging operation
        logging.info('Entered the backward_elimination_approach method of the LinearRegressionWithFeatureSelection class')
        try:
            ...
            while len(cols) > 0:
                ...
                x_1 = sm.add_constant(x_1)  # adding constant, as the OLS method from stats models by default considers the regression line as a line passing through the origin.
                lr = sm.OLS(self.y_train,x_1).fit()  # fitting using OLS or Ordinary least squares method from stats models
            ...
            print()
            print("Features selected by the Backward elimination method in Linear regression are ",selected_features_be)
            print()
